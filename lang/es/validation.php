...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes de error por defecto del validador. El marcador :attribute se
    | reemplaza por el nombre legible definido en la sección "attributes".
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Esta :attribute apareció en una filtración de datos. Elige una diferente para mantener tu cuenta segura.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes definir mensajes personalizados con la convención
    | "attribute.rule" para afinar el texto de un campo y regla específicos.
    |
    */

    'custom' => [
        'email' => [
            'required' => 'Escribe tu correo electrónico para continuar.',
            'email' => 'Ese correo no parece válido. Revisa que esté bien escrito.',
        ],
        'password' => [
            'required' => 'Escribe tu contraseña para continuar.',
        ],
        'current_password' => [
            'required' => 'Escribe tu contraseña actual para confirmar el cambio.',
        ],
        'authority_confirmed' => [
            'accepted' => 'Debes confirmar que cuentas con autorización para continuar.',
        ],
        'accept_terms' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplazan el marcador :attribute por un nombre más natural.
    |
    */

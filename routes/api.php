...
use App\Http\Controllers\Api\V1\Platform\WorkshopMaterialController;
    ...
    Route::middleware(['web', 'auth', 'verified', EnsurePasswordIsChanged::class, EnsureLegalDocumentsAccepted::class])->group(function (): void {
        ...
        Route::prefix('platform/tenants/{tenant}/workshop')
            ...
            ->group(function (): void {
                ...
                Route::get('orders/{order}/materials', [WorkshopMaterialController::class, 'index']);
                Route::post('orders/{order}/materials', [WorkshopMaterialController::class, 'store']);
                Route::post('orders/{order}/materials/{reservation}/consume', [WorkshopMaterialController::class, 'consume']);
                Route::post('orders/{order}/materials/{reservation}/release', [WorkshopMaterialController::class, 'release']);
                Route::post('orders/{order}/materials/{reservation}/return', [WorkshopMaterialController::class, 'returnToStock']);

...
#[Fillable(['tenant_id', 'workshop_device_id', 'received_by', 'assigned_to', 'ticket_number', 'status', 'priority', 'reported_fault', 'physical_condition', 'physical_conditions', 'accessories', 'diagnosis', 'estimated_total', 'approval_decision', 'approval_method', 'approval_notes', 'approval_recorded_by', 'approval_decided_at', 'received_at', 'completed_at', 'delivered_at'])]
class WorkshopOrder extends Model
{
    protected function casts(): array
    {
        return ['physical_conditions' => 'array', 'accessories' => 'array', 'estimated_total' => 'decimal:2', 'approval_decided_at' => 'datetime', 'received_at' => 'datetime', 'completed_at' => 'datetime', 'delivered_at' => 'datetime'];
    }
